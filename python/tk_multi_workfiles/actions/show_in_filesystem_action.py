...
class ShowPublishInFileSystemAction(ShowInFileSystemAction):
    ...
    def __init__(self, file, file_versions, environment):
        ShowInFileSystemAction.__init__(
            self, "Show Publish In File System", file, file_versions, environment
        )
...
class ShowWorkFileInFileSystemAction(ShowInFileSystemAction):
    ...
    def __init__(self, file, file_versions, environment):
        ShowInFileSystemAction.__init__(
            self, "Show In File System", file, file_versions, environment
        )
...
class ShowWorkAreaInFileSystemAction(ShowAreaInFileSystemAction):
    ...
    def __init__(self, file, file_versions, environment):
        ShowAreaInFileSystemAction.__init__(
            self, "Show Work Area In File System", file, file_versions, environment
        )
    ...
    def execute(self, parent_ui):
        ...
        if (
            ...
            or not self.environment.work_area_template
        ):
            return

        self._show_area_in_fs(
            self.file, self.environment, self.environment.work_area_template
        )
...
class ShowPublishAreaInFileSystemAction(ShowAreaInFileSystemAction):
    ...
    def __init__(self, file, file_versions, environment):
        ShowAreaInFileSystemAction.__init__(
            self, "Show Publish Area In File System", file, file_versions, environment
        )
    ...
    def execute(self, parent_ui):
        ...
        if (
            not self.environment
            or not self.environment.context
            or not self.environment.publish_area_template
        ):
            return

        self._show_area_in_fs(
            self.file, self.environment, self.environment.publish_area_template
        )
