...
class SgRunner(threading.Thread):
        ...
        self._sg_searches = [
            {
                ...
                "filters": [
                    [
                        "project",
                        "is",
                        {"type": "Project", "name": "Another Demo Project", "id": 67},
                    ],
    ...
    def run(self):
        ...
        while True:
            ...
            res = self._shotgun.find(
                sg_search["entity_type"],
                sg_search["filters"],
                sg_search["fields"],
                sg_search["order"],
            )
        ...
        if search_id == 0:
            ...
            self._update_groups(
                [
                    ...
                    "FX - Effects",
                    "FX - More FX",
                    "Light - EvenMoreLighting",
                    "Light - Lighting",
                    "Light - MoreLighting",
                    "Light - StillMoreLighting",
                    "Light - YetMoreLighting",
                    "More Anim - MoreAnim",
                    "Roto - Roto",
                ]
            )
            ...
            self._add_files(
                ...
                [
                    "testscene",
                    "writenodetestBAD",
                    "writenodeconversiontest",
                    "scene",
                    "writenodetest",
                    "osxreviewtest",
                    "writenodeconversiontestb",
                    "testscene",
                    "sendtoreviewtest",
                    "osxreviewtest",
                    "testscene",
            ...
            self._update_groups(
                ["The End", "Anm - Animation", "Anm - Animation B", "Comp - Finalize"]
            )
            grp = self._add_group("Anm - Animation")
            self._add_files(
                grp,
