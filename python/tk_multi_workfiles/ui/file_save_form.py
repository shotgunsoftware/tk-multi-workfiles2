...
class Ui_FileSaveForm(object):
    def setupUi(self, FileSaveForm):
        ...
        self.location_label = QtGui.QLabel(self.location_page)
...
"}")
        ...
        self.preview_label = QtGui.QLabel(FileSaveForm)
        self.preview_label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.preview_label.setIndent(-1)
        self.preview_label.setObjectName("preview_label")
        self.preview_grid.addWidget(self.preview_label, 0, 0, 1, 1)
        self.file_name_preview = QtGui.QLabel(FileSaveForm)
        ...
        self.work_area_preview = QtGui.QLabel(FileSaveForm)
        ...
        self.preview_label_2.setIndent(-1)
        self.preview_label_2.setObjectName("preview_label_2")
        self.preview_grid.addWidget(self.preview_label_2, 1, 0, 1, 1)
        self.preview_grid.setColumnMinimumWidth(0, 80)
        self.preview_grid.setColumnStretch(1, 1)
        self.verticalLayout_2.addLayout(self.preview_grid)
...
"two", None, QtGui.QApplication.UnicodeUTF8))
        self.preview_label_2.setText(QtGui.QApplication.translate("FileSaveForm", "<html><head/><body><p><span style=\" font-weight:600;\">Work Area:</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
