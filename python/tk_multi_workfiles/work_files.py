...
class WorkFiles(object):
    ...
    def _init_change_work_area_form(self, form):
        """
        Initialize change work area form - allows
        us to hook up signals etc.
        """
        form.create_task.connect(lambda f=form: self._on_create_new_task(f))
        
    def _on_create_new_task(self, form):
        """
